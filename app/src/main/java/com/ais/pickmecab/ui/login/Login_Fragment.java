...
import static com.ais.pickmecab.Utils.ForgotPassword_Fragment;
...
public class Login_Fragment extends Fragment implements OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final EditText usernameEditText = view.findViewById(R.id.login_emailid);;
        final EditText passwordEditText = view.findViewById(R.id.login_password);;
        final Button loginButton = view.findViewById(R.id.loginBtn);
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if (actionId == EditorInfo.IME_ACTION_DONE) {
                    loginViewModel.login(usernameEditText.getText().toString(),
                            passwordEditText.getText().toString(),mContext);
                }
                return false;
            }
        });
